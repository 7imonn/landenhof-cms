...
blueprint: job
title: 'Fachlehrperson Französisch Primar (Dupliziert)'
...
components:
            ...
            content:
              -
                ...
                content:
                  -
                    type: text
                    text: 'Hohe Bereitschaft zur Zusammenarbeit, Teamfähigkeit, offene und transparente Kommunikation, Konfliktfähigkeit, Lernbereitschaft, regelmässiges Weiterbilden im Team und individuell '
          -
            type: list_item
            content:
              -
  ...
  -
    ...
    files:
      -
        id: lf80zrx8
        name: 'Fachlehrperson Französisch Primar'
        file: downloads/fachlehrperson_franzoesisch_august_2023.pdf
        open_in_tab: false
...
heading:
  -
    ...
    content:
      -
        type: text
        text: 'Fachlehrperson Französisch Primar (6 Wochenlektionen)'
content:
  -
    type: paragraph
    content:
