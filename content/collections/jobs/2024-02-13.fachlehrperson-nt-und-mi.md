---
id: 152525f1-e675-468c-b128-40631d6f2d1e
blueprint: job
title: 'Stellvertretung als Fachlehrperson NT und MI'
heading:
  -
    type: paragraph
    content:
      -
        type: text
        text: 'Stellvertretung als Fachlehrperson NT und MI Real- & Sekundarschule'
    ...
    text:
      -
        ...
        content:
          -
            type: text
            text: '8 Wochenlektionen'
      -
        type: paragraph
        content:
          -
            type: text
            text: 'Unterrichtstage: Mittwochnachmittag, Donnerstagmorgen, Freitagmorgen'
  -
    id: lebivic4
    title: 'Fächer:'
    text:
      -
        ...
        content:
          -
            type: text
            text: '6 Lekt. Natur + Technik (Realschule), '
      -
        type: paragraph
        content:
          -
            type: text
            text: '2 Lekt. Medien + Informatik (Sekundarschule)'
components:
  -
    id: lebix46h
    text:
      ...
      -
        ...
        content:
          -
            type: text
            text: 'Fachlehrperson NT und MI Real- & Sekundarschule'
      -
        type: paragraph
        content:
          -
            ...
            content:
              -
                ...
                content:
                  -
                    type: text
                    text: 'Fachlehrperson Natur + Technik und Medien + Informatik'
          -
            type: list_item
            content:
              -
  ...
  -
    ...
    files:
      -
        id: lf81hvio
        name: 'Fachlehrperson NT und MI Real- & Sekundarschule'
        open_in_tab: true
        file: downloads/stelleninserat_fachlehrperson_real_sek_ab_februar_2024-1707830596.pdf
